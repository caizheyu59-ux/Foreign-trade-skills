...
```bash
sau kuaishou upload-video --account kingsway --file video.mp4 --title "标题" --desc-file desc.txt
sau kuaishou upload-note --account kingsway --images img1.png --title "标题" --note-file note.txt
```
